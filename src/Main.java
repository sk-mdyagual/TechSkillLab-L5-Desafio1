...
import principles.interfaces.Personalizado;
...
public class Main {
    public static void main(String[] args) {
        ...
        // 1. Format Personalizado
        Personalizado reporteNomina = empleado -> "Empleado: " + empleado.getNombre() + " " + empleado.getApellido() + " - Salario: $" + empleado.getSalario();
        Personalizado fichaPersonal = empleado -> "\nNombre: " + empleado.getNombre() + "\nApellido: " + empleado.getApellido() + "\nDepartamento: " + empleado.getDepartamento() + "\nCargo: " + empleado.getCargo();
        ...
        // 2. Predicate - Empleados con salario inferior a 700USD
